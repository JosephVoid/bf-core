...
public interface UsersRepository extends CrudRepository<Users, UUID> {
        ...
        @Query(value = """
                            UPDATE users SET
                                ...
                                WHERE users.id = :id
                        """, nativeQuery = true)
        void updateUsers(String id, String fname, String lname, String email, String pass, String desc, String phone,
                        String pic);
        ...
        @Query(value = """
                        ...
                        """, nativeQuery = true)
        List<Users> findUserWhoWantDesires(String desireId);
}