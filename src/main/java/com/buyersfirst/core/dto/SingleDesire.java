...
public class SingleDesire extends DesireListRsp {
    ...
    public SingleDesire(String id, String title, String description, String postedBy, String postedById, Double price, Integer views,
        ...
        super(id, title, description, postedBy, postedById, price, views, wants, bids, isClosed, picture, postedOn, tags, minPrice,
                maxPrice, metric);
