...
ALTER TABLE desires MODIFY COLUMN desired_price DOUBLE(18, 2);
...
-- Add column
ALTER TABLE desires ADD COLUMN metric VARCHAR(36) DEFAULT NULL, ADD COLUMN min_price DOUBLE(18, 2) DEFAULT 0, ADD COLUMN max_price DOUBLE(18, 2) DEFAULT 0;

-- set min max
UPDATE desires SET min_price = desired_price, max_price = desired_price;

-- set metric
UPDATE desires SET metric = '69e45ebb-ffae-46a1-a1e5-4fc838138374';